<main>
    <div class="grid-page-product">
        <div class="item">
            <div class="title-page-product" onclick="window.location='index.php?action=Originals'">Sportswear</div>
            ...
            <div class="product" id="listOriginals">
                <?php
                $limit = 8;
                $countProduct = $product -> countSportswear();
                ...
                $pdNew = $product->getSportswear($limit, $index);
        ...
        <div class="navigation">
                ...
                if($totalProduct > $limit):
                    ...
                    while($c < $numberPage):
                ?>
                    <button name='sportPage<?php echo $c ?>'><?php ++$c; echo $c ?></button>
                <?php
                    endwhile;
                endif;
                ?>
