<main>
    <div class="grid-page-product">
        <div class="item">
            <div class="title-page-product" onclick="window.location='index.php?action=Originals'">Tennis</div>
            ...
            <div class="product" id="listOriginals">
                ...
                $pdNew = $product->getTennis($limit, $index);
        ...
        <div class="navigation">
                ...
                if($totalProduct > $limit):
                    ...
                    while($c < $numberPage):
                ?>
                    <button name='tennisPage<?php echo $c ?>'><?php ++$c; echo $c ?></button>
                <?php
                    endwhile;
                endif;
                ?>
