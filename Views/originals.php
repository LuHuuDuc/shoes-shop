    ...
    <div class="grid-page-product">
        <div class="item">
            ...
            <div class="product">
                <?php
                $limit = 8;
                $countProduct = $product -> countOriginals();
                ...
                $d = 0;
                while($d < $numberPage){
                    if(isset($_POST['originalsPage'.$d.''])){
                        $index = $limit*$d;
                        break;
                    }
                    else{
                ...
                $pdNew = $product->getOriginals($limit ,$index);
        ...
        <div class="navigation">
                ...
                if($totalProduct > $limit):
                    ...
                    while($c < $numberPage):
                ?>
                    <button name='originalsPage<?php echo $c ?>'><?php ++$c; echo $c ?></button>
                <?php
                    endwhile;
                endif;
                ?>
